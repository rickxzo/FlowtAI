...
<template>
  <div class="h-screen flex flex-col bg-zinc-950 text-white pt-20" style="font-family: 'Space Grotesk';">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <!-- HEADER -->
      <div class="max-w-7xl mx-auto px-4 sm:px-8 py-6 w-full
  ...
  <!-- Title -->
        ...
        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <input
            ...
            class="bg-zinc-900 border border-zinc-800 px-4 py-2 rounded-lg outline-none w-full sm:w-64"
          />
      
          <!-- Sort -->
          <select
            v-model="sort"
            class="bg-zinc-900 border border-zinc-800 px-4 py-2 rounded-lg outline-none w-full sm:w-40"
          >
